% Script to compute the contribution of each pre to reconstruct all the posts in Monkey B PFc.
% This script is used to produce Figure 3d of the paper.

clear all;
%%
load('path/to/Kernel/B/KernelAndPerfPF_trans3000.mat')
%%
...
%% how much each pre contributes to reconstruct all the posts
% ChNormRange = [0 0.275];
% pre = 1;
