% Script to train the AR model for the Monkey B PMc.
% Changing the transient period to 100 (Wa.), 3000 (An.), 7600 (Aw.).
% This script reproduces figure 2b of the paper.
%%
clear all;
%%
...
%%
Ch = setdiff(97:192,[174,113,131,133]);
AllCh =97:192;
% Ch = 1:96;
for c=1:numel(AllCh)
...
%%    
save('KernelAndPerfPM_trans7600.mat', 'Kernel','PerformanceTraining','OutReconstructTraining','PerformanceTest','PvalueTest','OutReconstructTest','OutOrig','OutOrigTest');
%%
