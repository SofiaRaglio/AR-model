% Script to train the AR model on PFc and testing on PMc for the Monkey B dataset.
...
AllChOut =97:192;
AllChIn = 1:96;
ChOut = setdiff(97:192,[174,113,131,133]);
ChIn = setdiff(1:96,[66,20,88]);
...
%%    
save('KernelAndPerfPF2PM_trans100.mat', 'Kernel','PerformanceTraining','OutReconstructTraining','PerformanceTest','PvalueTest','OutReconstructTest','OutOrig','OutOrigTest');
%%
...
MEAMap1 = [0 105 104 103 106 107 108 109 0 111;
