% Script to compute the correlations between the Kernel PCA components for the Monkey B.
% This script is used to produce Figure 4a of the paper.
clear all;
%% load the kernel with transient=100s
load('path/to/KernelAndPerfPF_trans100.mat');
KernelAw = Kernel;
