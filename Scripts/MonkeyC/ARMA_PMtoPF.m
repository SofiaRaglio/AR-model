% Script to train the AR model on PMc and testing on PFc for the Monkey C dataset.
...
%%    
save('KernelAndPerfPM2PF_trans6250.mat', 'Kernel','PerformanceTraining','OutReconstructTraining','PerformanceTest','PvalueTest','OutReconstructTest','OutOrig','OutOrigTest');
%%
...
MEAMap2 = [0 113 115 116 117 118 119 120 185 0;
